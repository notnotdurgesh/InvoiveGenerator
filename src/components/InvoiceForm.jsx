...
const InvoiceForm = () => {
  ...
  const handleProductSelect = (selectedProduct) => {
    // Add the selected product to the formData
    const newItem = {
        ...
        <Col md={8} lg={9}>
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            ...
            <InvoiceItem
              ...
              selectedProducts={selectedProducts} // Pass the selectedProducts array
            />
            {productsList.length > 0 ? (
                    <ProductSelect onProductSelect={handleProductSelect} />
                  ) : (
                    <div className="d-flex justify-content-center my-3">
                      <Button variant="primary" onClick={handleNoProductsAvailable}>
                        Add Products
                      </Button>
                    </div>
                  )}            
